...
cd /app
rm -rf /app/*  #removing the old or existing  code"
unzip /tmp/backend.zip &>>$LOG_FILE
VALIDATE $? "extrating the  backend code"
...
mysql -h mysql.bng81s.online -uroot -pExpenseApp@1 < /app/schema/backend.sql &>>$LOG_FILE
